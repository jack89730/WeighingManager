...
#define TYPE_WINDOW					1	//标准窗体
#define TYPE_PUSHBUTTON				2	//普通按钮
#define TYPE_CHECKBOX				3	//复选框
#define TYPE_EDITBOX				4	//文本框
#define TYPE_COMBOBOX				5	//组合框
#define TYPE_LISTBOX				6	//列表框
#define TYPE_GROUPBOX				7	//分组框
#define TYPE_RADIOBUTTON			8	//单选框
#define TYPE_STATIC					9	//静态控件
