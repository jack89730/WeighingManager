...
LRESULT CDrawDialog::OnNcPaint(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnNcCalcSize(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnNcHitTest(WPARAM wParam, LPARAM lParam)
{
	CRect rtButton;
	CRect rcWindow;
	GetWindowRect(m_hWnd,&rcWindow);
...
LRESULT CDrawDialog::OnGetMinMaxInfo(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnNcActivate(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnActivate(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnNcLButtonDblClk(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnNcLButtonDown(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnNcLButtonUp(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnNcMouseMove(WPARAM wParam, LPARAM lParam)
{
	UINT nHitTest = wParam;
	CPoint point(LOWORD(lParam),HIWORD(lParam));
	LRESULT lResult = 0;
...
LRESULT CDrawDialog::OnNcMouseHover(WPARAM wParam, LPARAM lParam)
{
	m_bNCHovering = TRUE;
	return 1;
}

LRESULT CDrawDialog::OnNcMouseLeave(WPARAM wParam, LPARAM lParam)
{
	m_bNCTracking = FALSE;
	m_bNCHovering = FALSE;
...
LRESULT CDrawDialog::OnSize(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::OnSysCommand(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CDrawDialog::WindowProc(HWND hWnd,UINT message, WPARAM wParam, LPARAM lParam)
{

	CDrawDialog* pThis = (CDrawDialog*)GetProp(hWnd, g_szPropSkinWnd);
	if (pThis==NULL)
	{
		return 0;
	}
...
BOOL  CDrawDialog::Attach(HWND hWnd)
{
	m_hWnd = hWnd;
	...
	::SetWindowLongPtr(m_hWnd, GWLP_WNDPROC, (INT_PTR)CDrawDialog::WindowProc);
...
CDUIButton* CDrawDialog::AddTitleButton(LPRECT lpRect, Image *pImage, UINT nCount /*= 3*/ , UINT nID/* = 0*/,LPCTSTR lpszCaption/*=NULL*/)
{
...
int CDrawDialog::TButtonHitTest(CPoint point, CRect& rtButton)
{
	std::map<int,CDUIButton>::iterator iter;
	for (iter = m_TitleBtn.begin(); iter != m_TitleBtn.end(); iter++)
	{
